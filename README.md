...
```bash
composer tailwind:build assets/css/tailwind.css -o assets/styles.css --watch
...
```bash
CECIL_ENV=production composer tailwind:build assets/css/tailwind.css -o assets/styles.css --minify
