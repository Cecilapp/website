...
The [first functional version](https://github.com/Cecilapp/Cecil/tree/58cd48bcc72baa7636ffdd0520d26c2847130537) of Cecil (then named PHPoole) was published in Sep 2013 and was a simple PHP 5.3 script powered by [Zend Framework Console component](https://github.com/zendframework/zend-console) and Twig.

## Authors

- Cecil is maintained by [Arnaud Ligny](https://arnaudligny.fr), a Web & eCommerce consultant
- The logo has been created by [Cécile Ricordeau](https://www.cecillie.fr), an amazing creative director ❤️

## License

- _Cecil_ is a free software distributed under the terms of the [EUPL-1.2](https://github.com/Cecilapp/Cecil/blob/master/LICENSE) license.
- The content of the website _cecil.app_ is distributed under [CC BY-SA 4.0](https://creativecommons.org/licenses/by-sa/4.0/)
