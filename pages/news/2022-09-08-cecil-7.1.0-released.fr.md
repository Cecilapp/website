...
Reportez-vous à la [documentation](/documentation/configuration/#translations).

#### Options du cache des traductions
...
Reportez-vous à la [documentation](/documentation/configuration/#cache).
